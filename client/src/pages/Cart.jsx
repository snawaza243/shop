...
const KEY = process.env.E_SHOP_SP;
...
const Cart = () => {
  ...
  const history = useNavigate() //instead of useHistory
        ...
        <Bottom>
          ...
          <Summary>
            ...
            <StripeCheckout
              ...
              token={onToken}
              stripeKey='pk_test_51NIyXsSFFeFG09QPBKOfUsLLUFTkHI4qpVAq1YTmd4FfIYtt8aayfQYnZbYVZIurWHlgeBhlPIbUdJQy2Fye4lFm0075DC44eR'
            // stripeKey= {KEY}
            // stripeKey= {process.env.E_SHOP_SP}
// 
            >
